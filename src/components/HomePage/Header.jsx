...
const Header = () => {
  return (
    <header className='max-w-[92rem] | m-auto mt-10 mb-40 px-8 py-4 | font-semibold | bg-gray100 | flex justify-between items-center | border border-gray300 rounded-[6.25rem]'>
